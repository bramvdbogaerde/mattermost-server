...
func (s *LocalCacheSupplier) GroupCreateMember(ctx context.Context, groupMember *model.GroupMember, hints ...LayeredStoreHint) *LayeredStoreSupplierResult {
	return s.Next().GroupCreateMember(ctx, groupMember, hints...)
}
