...
func (s *SqlSupplier) GroupCreateMember(ctx context.Context, member *model.GroupMember, hints ...store.LayeredStoreHint) *store.LayeredStoreSupplierResult {
	result := store.NewSupplierResult()
	...
	member.CreateAt = model.GetMillis()
